...
A robust, production-style implementation of a Singly Circular Linked List in C. This project demonstrates advanced C concepts including manual memory management, pointer manipulation, and data encapsulation.
...
```html
		|-CircularLinkedList
			|-circularlinkedlist.h			-- The interface: contains struct definitions, enums, and function prototypes.
			|-circularlinkedlist.c			-- The logic: contains the implementation of the linked list operations.
...
## How to Run (Visual Studio)
 ...
 - Build and Run (F5).
 - create the build directory and go to this directory
 - write command ```cmake ..``` and ```cmake --build .``.
